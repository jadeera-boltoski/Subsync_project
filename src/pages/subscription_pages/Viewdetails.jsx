        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-50 p-4 rounded">
              ...
              <div className="space-y-2">
                {/* {parseFloat(subscription.cost).toLocaleString('en-UK', { minimumFractionDigits: 0, maximumFractionDigits: 2 })} */}
            ...
            <div className="bg-gray-50 p-4 rounded">
              ...
              <div className="space-y-2">
                <p><span className="font-medium">Start Date:</span>  {format(new Date(subscription.start_date), "dd-MM-yyyy")}</p>
                <p><span className="font-medium">End Date:</span> {subscription.end_date
